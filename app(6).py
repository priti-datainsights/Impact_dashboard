...
# SESSION / APP STATE
# ==========================================
# Google authentication has been removed. The app opens directly to the
# application home page. A generic display name is retained so existing
# sidebar/header text continues to work without requiring user credentials.
